                    ...
                    if (d.length >= set.minimumLength)
                    {
                         ...
                         if (c != 0)
                         {
                              ...
                              if (c > set.show)
                              {
                                   ...
                                   if (start > 0)
                                   {
                                       pagination += '<span class="pagination_element prev"><a data-id="' + (start - set.show) + '_' + replace + '">«</a></span>'; 
                                   } else {
                                   ...
                                   if (page <= 2)
                                   {
                                        ...
                                        for (var f = 0; f < p_b; f++)
                                        {
                                             ...
                                             {
                                                  pagination += '<span class="pagination_element"><a data-id="' + (f * set.show) + '_' + replace + '">' + (f + 1) + '</a></span>';
                                             }
                                        }
                                   }
                                   else
                                   {
                                        ...
                                        for (var f = page - 1; f < p_b; f++)
                                        {
                                             ...
                                             {
                                                  pagination += '<span><a class="tipue_search_foot_box" data-id="' + (f * set.show) + '_' + replace + '">' + (f + 1) + '</a></span>';
                                             }
                                        }
                                   }                         
                                   ...
                                   if (page + 1 != pages)
                                   {
                                       pagination += '<span class="next pagination_element"><a data-id="' + (start + set.show) + '_' + replace + '">»</a></span>'; 
                                   } else {
