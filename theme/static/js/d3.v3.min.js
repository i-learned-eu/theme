d3 = (function () {
    ...
    function L(t, n) {
        ...
        return (
            ...
            function (r) {
                return (
                    1 +
                    t * Math.pow(2, 10 * -r) * Math.sin((2 * (r - e) * Ti) / n)
                )
            }
        )
    }
    ...
    function zn(t, n, e, r) {
        var u =
                t.__transition__ ||
                (t.__transition__ = { active: 0, count: 0 }),
            a = u[e]
        if (!a) {
            var o = r.time
            return (
    ...
    function Ln(t, n, e, r) {
        ...
        return Tn(
            ...
            'function' == typeof e
                ? function (t, i, a) {
                      t.__transition__[u].tween.set(
                          n,
                          r(e.call(t, t.__data__, i, a))
                      )
                  }
                : ((e = r(e)),
                  function (t) {
    ...
    function Fn() {
        ...
        var r = Hn() - n
        r > 24
            ? (isFinite(r) && (clearTimeout(Na), (Na = setTimeout(Fn, r))),
              (Aa = 0))
            : ((Aa = 1), za(Fn))
    }
    function Hn() {
    ...
    function $n(t, n) {
        return Ci.format(
            ',.' +
                Math.max(
                    0,
                    -Math.floor(Math.log(Xn(t, n)[2]) / Math.LN10 + 0.01)
                ) +
                'f'
        )
    }
    ...
    function me(t) {
        for (
            var n = 0, e = t.length, r = t[0], u = [r[0], ',', r[1]];
            e > ++n;
    ...
    function ye(t, n) {
        return 4 > t.length
            ? pe(t)
            : t[1] + xe(t.slice(1, t.length - 1), _e(t, n))
    }
    function Me(t, n) {
        return 3 > t.length
            ? pe(t)
            : t[0] +
                  xe(
                      (t.push(t[0]), t),
                      _e([t[t.length - 2]].concat(t, [t[1]]), n)
                  )
    }
    function be(t, n) {
    ...
    function ke(t) {
        for (
            var n, e, r = -1, u = t.length, i = u + 4, a = [], o = [];
            4 > ++r;
    ...
    function Ce(t) {
        for (
            var n, e, r, u, i = [], a = qe(t), o = -1, c = t.length - 1;
            c > ++o;
    ...
    function iu(t, n) {
        ...
        return function (u, i, a, o) {
            ...
            for (var c, l = a * n, f = u; a > 0 ? f > i : i > f; f -= l)
                o.point(
                    (c = Vr([e, -r * Math.cos(f), -r * Math.sin(f)]))[0],
                    c[1]
                )
        }
    }
                ...
                insert: function (t, n, e) {
                    ...
                    for (var r = 0, u = i.list, a = u.length; a > r; r++) {
                        ...
                        if (
                            !(
                                t.ystar > o.ystar ||
                                (t.ystar == o.ystar && n.x > o.vertex.x)
                            )
                        )
                            break
                    }
    ...
    ;(Ci.map = function (t) {
        ...
        e(i, {
            ...
            forEach: function (t) {
                for (var n in this)
                    n.charCodeAt(0) === Xi &&
                        t.call(this, n.substring(1), this[n])
            },
        })
    var Zi = '\0',
        Xi = Zi.charCodeAt(0)
    ;(Ci.functor = c),
        ...
        (Ci.extent = function (t, n) {
            ...
            if (1 === arguments.length) {
                ...
                for (
                    ;
                    a > ++i && (null == (e = u = n.call(t, t[i], i)) || e != e);
            ...
            for (
                ...
                if (((a = f[r]), a.x == e[0])) {
                    if (a.i)
                        if (null == l[a.i + 1])
                            for (
                                l[a.i - 1] += a.x, l.splice(a.i, 1), u = r + 1;
                                i > u;
                                ++u
                            )
                                f[u].i--
        ...
        (ba.selectAll = function (t) {
            ...
            for (var u = -1, i = this.length; i > ++u; )
                for (var a = this[u], o = -1, c = a.length; c > ++o; )
                    (e = a[o]) &&
                        (r.push((n = Ui(t.call(e, e.__data__, o)))),
                        (n.parentNode = e))
            return mn(r)
        }),
    ...
    ;(Ci.selection.enter = qn),
        ...
        (_a.select = function (t) {
            for (
                var n, e, r, u, i, a = [], o = -1, c = this.length;
                c > ++o;
                ...
                for (var l = -1, f = u.length; f > ++l; )
                    (i = u[l])
                        ? (n.push(
                              (r[l] = e = t.call(u.parentNode, i.__data__, l))
                          ),
    ...
    ;(Ci.timer = function (t, n, e) {
        ...
        r && r.callback === t
            ? ((r.then = e), (r.delay = n))
            : (qa[(t.id = ++Ta)] = Ca =
                  { callback: t, then: e, delay: n, next: Ca }),
        ...
        function u() {
            ...
            function h() {
                ...
                m && ((t[0] += m[0]), (t[1] += m[1])),
                    ...
                    i &&
                        (n(b),
                        M({ type: 'brush', mode: S ? 'move' : 'resize' }))
            }
            function g(t, n, e) {
                var r,
                    u,
        ...
        (Ci.behavior.drag = function () {
            ...
            function n() {
                ...
                var a,
                    ...
                    l = Ci.event.target,
                    f = Ci.event.touches
                        ? Ci.event.changedTouches[0].identifier
                        : null,
                    s = t(),
                    h = 0,
                    g = Ci.select(Fi)
                        ...
                        .on(
                            null != f ? 'touchend.drag-' + f : 'mouseup.drag',
                            u,
                            !0
                        )
                r
        ...
        (Ci.behavior.zoom = function () {
            ...
            function f() {
                ...
                r(
                    Math.pow(
                        2,
                        Ci.event.shiftKey ? Math.ceil(i) - 1 : Math.floor(i) + 1
                    )
                ),
                    u(t, e),
                    a(w.of(this, arguments))
        ...
        (Ci.layout.force = function () {
            ...
            return (
                (c.tick = function () {
                    ...
                    for (e = 0; _ > e; ++e)
                        (a = y[e]),
                            ...
                            (g = M * M + b * b) &&
                                ((g =
                                    (r * i[e] * ((g = Math.sqrt(g)) - u[e])) /
                                    g),
                                (M *= g),
                                (b *= g),
                                (h.x -=
                                    M * (m = c.weight / (h.weight + c.weight))),
                                (h.y -= b * m),
                                (c.x += M * (m = 1 - m)),
                                (c.y += b * m))
                    if (
                        (m = r * d) &&
                        ((M = f[0] / 2), (b = f[1] / 2), (e = -1), m)
                    )
                        for (; x > ++e; )
                            (a = v[e]),
                                (a.x += (M - a.x) * m),
                    ...
                    if (p)
                        for (
                            Ke((n = Ci.geom.quadtree(v)), r, o), e = -1;
                            x > ++e;
                ...
                (c.start = function () {
                    ...
                    for (e = 0; d > e; ++e)
                        (l = y[e]),
                            'number' == typeof l.source &&
                                (l.source = v[l.source]),
                            'number' == typeof l.target &&
                                (l.target = v[l.target]),
                            ++l.source.weight,
                            ++l.target.weight
                    for (e = 0; s > e; ++e)
    ...
    Ci.layout.stack = function () {
        function t(a, c) {
            ...
            for (g = 0; v > g; ++g)
                for (
                    u.call(t, l[0][g], (p = d[g]), f[0][g][1]), h = 1;
                    m > h;
                    ++h
                )
                    ...
                    var a,
                        ...
                        d =
                            'slice' === g
                                ...
                                : Math.min(l.dx, l.dy)
                    for (
                        t(h, (l.dx * l.dy) / e.value), f.area = 0;
                        (c = h.length) > 0;
            ...
            function e(n) {
                ...
                if (r && r.length) {
                    var i,
                        ...
                        c = []
                    for (
                        t(o, (a.dx * a.dy) / n.value), c.area = 0;
                        (i = o.pop());
                ...
                if (n == e.dx) {
                    for ((r || f > e.dy) && (f = e.dy); a > ++i; )
                        (u = t[i]),
                            ...
                            (u.dy = f),
                            (o += u.dx =
                                Math.min(e.x + e.dx - o, f ? c(u.area / f) : 0))
                    ;(u.z = !0),
                        (u.dx += e.x + e.dx - o),
                        (e.y += f),
                        (e.dy -= f)
                    ...
                    for ((r || f > e.dx) && (f = e.dx); a > ++i; )
                        (u = t[i]),
                            ...
                            (u.dx = f),
                            (l += u.dy =
                                Math.min(e.y + e.dy - l, f ? c(u.area / f) : 0))
                    ;(u.z = !1),
                        (u.dy += e.y + e.dy - l),
                        (e.x += f),
                        (e.dx -= f)
    ...
    ;((Ci.geo.azimuthalEquidistant = function () {
        ...
        (Ci.geo.centroid = function (t) {
            ...
            var n
            return so &&
                Math.abs((n = Math.sqrt(ho * ho + go * go + po * po))) > qi
                ? [
                      Math.atan2(go, ho) * Di,
        ...
        function n(n) {
            for (var r, u, i, a = [], o = -1, c = 0; e > ++o; )
                37 === t.charCodeAt(o) &&
                    ...
                    null != (u = Xo[(r = t.charAt(++o))]) &&
                        (r = t.charAt(++o)),
                    (i = Bo[r]) &&
                        (r = i(n, null == u ? ('e' === r ? ' ' : '0') : u)),
                    a.push(r),
                    (c = o + 1))
    ...
    ;(Ci.time.format.iso =
        ...
        (Ci.time.dayOfYear = function (t) {
            ...
            return Math.floor(
                (t -
                    n -
                    6e4 * (t.getTimezoneOffset() - n.getTimezoneOffset())) /
                    864e5
            )
        }),
        Co.forEach(function (t, n) {
            ...
            var e = (Ci.time[t] = Mi(
                function (t) {
                    return (
                        (t = Ci.time.day(t)).setDate(
                            t.getDate() - ((t.getDay() + n) % 7)
                        ),
                        t
                    )
                },
                ...
                function (t) {
                    ...
                    return (
                        Math.floor((Ci.time.dayOfYear(t) + ((e + n) % 7)) / 7) -
                        (e !== n)
                    )
                }
            ))
