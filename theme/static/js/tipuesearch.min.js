  ...
  function getTipueSearch(start, replace) {
    ...
    if (standard) {
      ...
      for (var i = 0; i < d_w.length; i++) {
        var a_w = true
        for (
          var f = 0; f < tipuesearch_stop_words.length; f++
        ) {
    ...
    if (d.length >= set.minimumLength) {
      if (standard) {
        if (replace) {
          ...
          for (var i = 0; i < d_w.length; i++) {
            for (
              var f = 0; f < tipuesearch_replace.words.length; f++
            ) {
              if (
                d_w[i] ==
        ...
        for (var i = 0; i < d_w.length; i++) {
          for (
            var f = 0; f < tipuesearch_stem.words.length; f++
          ) {
        ...
        for (var i = 0; i < tipuesearch_in.pages.length; i++) {
          ...
          for (var f = 0; f < d_w.length; f++) {
            ...
            if (score != 0) {
              for (
                var e = 0; e < tipuesearch_weight.weight.length; e++
              ) {
                if (
        ...
        for (var i = 0; i < tipuesearch_in.pages.length; i++) {
          ...
          if (score != 0) {
            found.push({
              score: score,
              title: tipuesearchData.pages[i].title,
              desc: s_t,
              url: tipuesearchData.pages[i].url,
              category: tipuesearchData.pages[i].category,
              date: tipuesearchData.pages[i].date,
        ...
        for (var i = 0; i < found.length; i++) {
          if (l_o >= start && l_o < set.show + start) {
            ...
            if (t_w.length < set.descriptiveWords) {
              ...
              for (
                var f = 0; f < set.descriptiveWords; f++
              ) {
                t_d += t_w[f] + ' '
              }
            }
